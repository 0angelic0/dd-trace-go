...
var (
	...
	internalSymbolPrefixes = []string{
		"github.com/0angelic0/dd-trace-go",
...
// ex: github.com/0angelic0/dd-trace-go/internal/stacktrace.(*Event).NewException
// -> package: github.com/0angelic0/dd-trace-go/internal/stacktrace
// -> receiver: *Event
