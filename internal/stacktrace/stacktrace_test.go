...
func TestStackTraceCurrentFrame(t *testing.T) {
	...
	require.Equal(t, "github.com/0angelic0/dd-trace-go/internal/stacktrace", frame.Namespace)
...
func TestTruncatedStack(t *testing.T) {
	...
	require.Equal(t, "github.com/0angelic0/dd-trace-go/internal/stacktrace", lambdaFrame.Namespace)
	...
	for i := 1; i < defaultMaxDepth-defaultTopFrameDepth; i++ {
		...
		require.Equal(t, "github.com/0angelic0/dd-trace-go/internal/stacktrace", stack[i].Namespace)
...
func TestParseSymbol(t *testing.T) {
	for _, test := range []struct {
		...
		{"method-receiver-pointer", "github.com/0angelic0/dd-trace-go/internal/stacktrace.(*Test).Method", symbol{
			"github.com/0angelic0/dd-trace-go/internal/stacktrace",
			"*Test",
			"Method",
		}},
		{"method-receiver", "github.com/0angelic0/dd-trace-go/internal/stacktrace.(Test).Method", symbol{
			"github.com/0angelic0/dd-trace-go/internal/stacktrace",
			"Test",
			"Method",
		}},
		{"sample", "github.com/0angelic0/dd-trace-go/internal/stacktrace.TestGetPackageFromSymbol", symbol{
			"github.com/0angelic0/dd-trace-go/internal/stacktrace",
			"",
			"TestGetPackageFromSymbol",
		}},
		{"lambda", "github.com/0angelic0/dd-trace-go/internal/stacktrace.TestGetPackageFromSymbol.func1", symbol{
			"github.com/0angelic0/dd-trace-go/internal/stacktrace",
			"",
