...
package elastic // import "github.com/0angelic0/dd-trace-go/contrib/elastic/go-elasticsearch
...
// roundTripper is an implementation of http.RoundTripper that captures Elasticsearch spans.
