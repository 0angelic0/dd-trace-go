...
import (
	...
	sqltraced "github.com/0angelic0/dd-trace-go/contrib/database/sql"
...
// using (github.com/0angelic0/dd-trace-go/contrib/database/sql).Register.
...
func WithCallbacks(db *gorm.DB, opts ...Option) *gorm.DB {
	...
	log.Debug("contrib/gopkg.in/jinzhu/gorm.v1: Registering Callbacks: %#v", cfg)
